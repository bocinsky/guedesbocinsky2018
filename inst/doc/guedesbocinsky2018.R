params <-
structure(list(cores = 2L, clean = FALSE, google_maps_elevation_api_key = "", 
    tdar_un = "rbocinsk", tdar_pw = "Dreams5683"), .Names = c("cores", 
"clean", "google_maps_elevation_api_key", "tdar_un", "tdar_pw"
))
