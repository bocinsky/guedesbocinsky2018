...
**In order to install the research compendium, you currently must use the development version of the `devtools` package for _R_.**
...
Or, pass them as parameters when compiling the `guedesbocinsky2018.Rmd` RMarkdown vignette (see [Running the analysis], below):
...
**This is what you want to run to reproduce our results from the terminal. We strongly encourage you to run the analysis from _R_ if your goal is to explore how we developed the model, or to change parameters.**
...
**This is what you want to run to reproduce our results precisely. We strongly encourage you to run the analysis from _R_ if your goal is to explore how we developed the model, or to change parameters.**
