...
file.copy(from = "./figures/Data_file_S2_all_crossplot.html",
          to = "./submission/Data_file_S2_all_crossplot.htmls",
          overwrite = TRUE)
...
unlink(paste0(tempdir(),"/Data_file_S3_research_compendium/vignettes/data"),
       recursive = TRUE, 
       force = TRUE)
unlink(paste0(tempdir(),"/Data_file_S3_research_compendium/vignettes/figures"),
       recursive = TRUE, 
       force = TRUE)
unlink(paste0(tempdir(),"/Data_file_S3_research_compendium/vignettes/submission"),
       recursive = TRUE, 
       force = TRUE)
unlink(paste0(tempdir(),"/Data_file_S3_research_compendium/vignettes/guedesbocinsky2018_cache"),
       recursive = TRUE, 
       force = TRUE)
unlink(paste0(tempdir(),"/Data_file_S3_research_compendium/.git"),
       recursive = TRUE, 
       force = TRUE)
suppressWarnings(utils::tar("./submission/Data_file_S3_research_compendium.tar.gz",
           files = paste0(tempdir(),"/Data_file_S3_research_compendium"),
           compression = "gzip",
           tar = "internal",
           extra_flags = paste("--exclude 'vignettes/data'",
                               "'vignettes/figures'",
                               "'vignettes/submission'",
                               "'vignettes/guedesbocinsky2018_cache'")))
